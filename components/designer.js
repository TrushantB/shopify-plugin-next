...
const Designer = ({
  ...
  return (
    <div className=" bg-[#ffedc4] min-h-screen text-center">
      <button className={`pt-4 ${selectedTransform === null ? 'hidden' : ''}`} onClick={handleDeleteSelected}><svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 " fill="none" viewBox="0 0 24 24" stroke="currentColor">
