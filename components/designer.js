...
const Designer = ({
  ...
  return (
   ...
   {selectedTransform != null ? (<button onClick={handleDeleteSelected}><svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
