...
const quickTips = [
    {
        id: 1,
        title: 'Image size should not exceed 10MB & video size should not exceed 100MB'
    },
    {
        id: 2,
        title: 'Please avoid uploading images of celebrities, sports stars, TV characters, cartoon characters or images for which you do not own the copyrights.'
    },
    {
        id: 3,
        title: 'Please ensure to resize the images as necessary to fit the canvas. You can open the canvas & resize the image.'
    },
    {
        id: 4,
        title: 'Please avoid placing any text too close to the border since there are slight chances that it might get cut.'
    },

    {
        id: 5,
        title: 'Please Check final preview to see if the designs are placed as you wish.'
    },
]
